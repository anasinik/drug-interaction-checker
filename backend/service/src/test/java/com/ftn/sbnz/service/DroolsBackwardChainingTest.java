...
// @Test
// @DisplayName("BC1: Metformin is contraindicated via renal insufficiency ->
// reduced clearance -> drug accumulation")
...
// Collection<?> contraindicated = kieSession.getObjects(obj -> obj instanceof
// ContraindicatedWith);
...
// "Should find contraindication explanation for Metformin + renal
// insufficiency");

// ContraindicationExplanation explanation = (ContraindicationExplanation)
...
// "Chain should end at drug accumulation. Got: " +
// explanation.getCausalChain());

// System.out.println("BC1 PASSED - Metformin contraindicated via renal
// insufficiency");
// System.out.println("causal chain: " + explanation.getCausalChain());
// }

// @Test
// @DisplayName("BC1: Statin is contraindicated via causal chain liver disease
// -> reduced metabolism -> liver toxicity")
...
// "Chain should end at liver drug toxicity. Got: " +
// explanation.getCausalChain());
...
// @Test
// @DisplayName("BC1: Metformin is NOT contraindicated for a diagnosis that does
// not lead to drug accumulation")
...
// System.out.println("BC1 PASSED - Metformin correctly NOT contraindicated for
// hypertension");
// }

// @Test
// @DisplayName("BC2: grapefruit + statin is serious via causal chain grapefruit
// -> CYP3A4 -> reduced metabolism -> drug accumulation")
...
// InteractionSeverityExplanation explanation = (InteractionSeverityExplanation)
// explanations.iterator()
// .next();

// assertTrue(explanation.getCausalChain().contains("CYP3A4 inhibition"),
// "Chain should contain CYP3A4 inhibition. Got: " +
// explanation.getCausalChain());
// assertTrue(explanation.getCausalChain().contains("drug accumulation"),
// "Chain should end at drug accumulation. Got: " +
// explanation.getCausalChain());
...
// @Test
// @DisplayName("BC2: alcohol + antidepressant is serious via causal chain
// alcohol -> enhanced CNS depression")
// public void testBC2_AlcoholAntidepressantExplanation() {
// kieSession.insert(new SeverityExplanationRequest("alcohol consumption",
// "Antidepressant"));
// kieSession.fireAllRules();
...
// System.out.println("BC2 PASSED - alcohol + antidepressant severity
// explained");
// System.out.println("causal chain: " + explanation.getCausalChain());
// }
// }