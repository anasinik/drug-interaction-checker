...
public class RuleGenerator {
    ...
    private static void generateDrugDrugInteractions() throws IOException {
        List<Map<String, Object>> data = List.of(
                row2("ANTICOAGULANT", "ANTIBIOTIC", "SERIOUS", "Antibiotics reduce vitamin K-producing bacteria..."),
                row2("ANTIBIOTIC", "ANTICOAGULANT", "SERIOUS", "Antibiotics reduce vitamin K-producing bacteria..."),
                row2("ANTICOAGULANT", "ANTIDEPRESSANT", "MILD", "Increased risk of bleeding"),
                row2("ANTIDEPRESSANT", "ANTICOAGULANT", "MILD", "Increased risk of bleeding"),
                row2("ANTIDEPRESSANT", "ANTIDEPRESSANT", "CONTRAINDICATED", "Risk of serotonin syndrome"),
                row2("ANTIDIABETIC", "ANTIBIOTIC", "SERIOUS",
                        "Antibiotics may enhance antidiabetic effect causing hypoglycemia"),
                row2("ANTIBIOTIC", "ANTIDIABETIC", "SERIOUS",
                        "Antibiotics may enhance antidiabetic effect causing hypoglycemia"),
                row2("ANTIHYPERTENSIVE", "ANTIDEPRESSANT", "MILD", "Possible drop in blood pressure"),
                row2("ANTIDEPRESSANT", "ANTIHYPERTENSIVE", "MILD", "Possible drop in blood pressure"),
                row2("STATIN", "ANTIBIOTIC", "SERIOUS", "Increased risk of myopathy"),
                row2("ANTIBIOTIC", "STATIN", "SERIOUS", "Increased risk of myopathy"));
